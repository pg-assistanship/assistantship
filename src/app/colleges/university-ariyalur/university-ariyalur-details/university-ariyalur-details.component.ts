...
@Component({
  selector: 'app-university-ariyalur-details',
  templateUrl: './university-ariyalur-details.component.html',
  styleUrls: ['./university-ariyalur-details.component.css']
})
export class UniversityAriyalurDetailsComponent implements OnInit {
  ...
  nextpage() {
    this.router.navigate(['uni-ariyalur-viewform'], { relativeTo: this.route })
  }
