...
@Component({
  selector: 'app-university-nagercoil-details',
  templateUrl: './university-nagercoil-details.component.html',
  styleUrls: ['./university-nagercoil-details.component.css']
})
export class UniversityNagercoilDetailsComponent implements OnInit {
