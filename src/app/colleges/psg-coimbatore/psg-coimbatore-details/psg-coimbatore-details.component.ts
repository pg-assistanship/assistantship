...
@Component({
  selector: 'app-psg-coimbatore-details',
  templateUrl: './psg-coimbatore-details.component.html',
  styleUrls: ['./psg-coimbatore-details.component.css']
})
export class PsgCoimbatoreDetailsComponent implements OnInit {
