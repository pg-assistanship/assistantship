...
@Component({
  selector: 'app-university-dindigul-details',
  templateUrl: './university-dindigul-details.component.html',
  styleUrls: ['./university-dindigul-details.component.css']
})
export class UniversityDindigulDetailsComponent implements OnInit {
  ...
  nextpage() {
    this.router.navigate(['uni-dindigul-viewform'], { relativeTo: this.route })
  }
