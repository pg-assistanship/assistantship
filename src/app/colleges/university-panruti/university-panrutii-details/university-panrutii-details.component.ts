...
@Component({
  selector: 'app-university-panrutii-details',
  templateUrl: './university-panrutii-details.component.html',
  styleUrls: ['./university-panrutii-details.component.css']
})
export class UniversityPanrutiiDetailsComponent implements OnInit {
