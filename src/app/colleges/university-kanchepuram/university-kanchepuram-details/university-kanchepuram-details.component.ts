...
@Component({
  selector: 'app-university-kanchepuram-details',
  templateUrl: './university-kanchepuram-details.component.html',
  styleUrls: ['./university-kanchepuram-details.component.css']
})
export class UniversityKanchepuramDetailsComponent implements OnInit {
